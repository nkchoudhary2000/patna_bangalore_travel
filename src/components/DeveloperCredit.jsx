...
const DeveloperCredit = () => {
    ...
    return (
        <div className={`fixed bottom-4 right-4 z-[1000] flex items-center gap-3 bg-dark-900/90 backdrop-blur-md border border-white/10 px-4 py-2 rounded-full shadow-2xl transition-all duration-1000 pointer-events-auto ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'}`}>
            {/* Logo Placeholder */}
